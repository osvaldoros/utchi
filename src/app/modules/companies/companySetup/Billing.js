define([
	...
	"dojo/text!./templates/Billing.html", // this is what includes the html template
	"dojo/_base/lang",
	"dijit/registry",
	"dijit/Dialog",
	"app/form/Manager",
	...
	return declare("app.modules.companies.companySetup.Billing", [WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, StatefulModule, DCFormManager], {
			...
			startup:function(){
				...
				this.companyBillingForm = this.getWidget('companyBillingForm');
				this.companyBillingForm.set('storeUrl', emanda2.urls.COMPANY);
				this.configureForm(this.companyBillingForm);
			},
			...
			onActivate:function(){
				...
				this.loadHashEntityInForm(this.companyBillingForm);	
			},
