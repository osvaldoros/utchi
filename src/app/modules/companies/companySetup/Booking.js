define([
	...
	"dojo/text!./templates/Booking.html", // this is what includes the html template
	"dojo/_base/lang",
	"dijit/registry",
	"dijit/Dialog",
	"app/form/Manager",	
	...
	function(declare, on, WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, StatefulModule, template, lang, registry, Dialog, Manager, DCFormManager, GridFromHtml, Memory, Observable, Cache, JsonRest, Selection, parser, query, Button,
			Validate, Editor, DCEditor, TextBox, TimeTextBox, DateTextBox, FilteringSelect, CheckBox, RadioButton, ValidationTextBox, CheckedMultiSelect, BusyButton){
	...
	return declare("app.modules.companies.companySetup.Booking", [WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, StatefulModule, DCFormManager], {
			...
			startup:function(){
				...
				this.companyBookingForm = this.getWidget('companyBookingForm');
				this.companyBookingForm.set('storeUrl', emanda2.urls.COMPANY);
				this.configureForm(this.companyBookingForm);				
			...
			onActivate:function(){
				...
				this.loadHashEntityInForm(this.companyBookingForm);	
			},
