define([
	"dojo/_base/declare",
	"dojo/on",
	"dojo/text!./templates/ConfigEquipmentDialog.html", // this is what includes the html template
	"dojo/_base/lang",
	"dijit/registry",
	"dijit/Dialog",
	"dijit/form/Button",
...
            //templateString: template, // Our template - important!
			...
			startup:function(){
				...
				this.submitEquipmentButton = this.getWidget('submitEquipmentButton');
			...
			onShow:function(){
				...
				this.eventHandlers.push( on(this.submitEquipmentButton, 'click', lang.hitch(this, "onSubmitClicked")) );
			},
