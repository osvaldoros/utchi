define([
	"dojo/_base/declare",
	"dojo/on",
	"dojo/text!./templates/ConfigBiologicalMonitoringDialog.html", // this is what includes the html template
	"dojo/_base/lang",
	"dijit/registry",
	"dijit/Dialog",
	"dijit/form/Button",
...
        return declare(Dialog, {
			...
			title:'Configure Biological Monitoring',
...
            //templateString: template, // Our template - important!
			...
			startup:function(){
				...
				this.submitBiologicalMonitoringButton = this.getWidget('submitBiologicalMonitoringButton');
			...
			onShow:function(){
				...
				this.eventHandlers.push( on(this.submitBiologicalMonitoringButton, 'click', lang.hitch(this, "onSubmitClicked")) );
			},
