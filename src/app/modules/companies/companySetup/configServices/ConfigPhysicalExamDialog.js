define([
	"dojo/_base/declare",
	"dojo/on",
	"dojo/text!./templates/ConfigPhysicalExamDialog.html", // this is what includes the html template
	"dojo/_base/lang",
	"dijit/registry",
	"dijit/Dialog",
	"dijit/form/Button",
...
            //templateString: template, // Our template - important!
			...
			startup:function(){
				...
				this.submitPhysicalExamButton = this.getWidget('submitPhysicalExamButton');
			...
			onShow:function(){
				...
				this.eventHandlers.push( on(this.submitPhysicalExamButton, 'click', lang.hitch(this, "onSubmitClicked")) );
			},
