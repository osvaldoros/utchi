define([
	"dojo/_base/declare",
	"dojo/on",
	"dojo/text!./templates/ConfigFingerprintDialog.html", // this is what includes the html template
	"dojo/_base/lang",
	"dijit/registry",
	"dijit/Dialog",
	"dijit/form/Button",
...
            //templateString: template, // Our template - important!
			...
			startup:function(){
				...
				this.submitFingerprintButton = this.getWidget('submitFingerprintButton');
			...
			onShow:function(){
				...
				this.eventHandlers.push( on(this.submitFingerprintButton, 'click', lang.hitch(this, "onSubmitClicked")) );
			},
