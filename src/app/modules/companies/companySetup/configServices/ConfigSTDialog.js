define([
	"dojo/_base/declare",
	"dojo/on",
	"dojo/text!./templates/ConfigSTDialog.html", // this is what includes the html template
	"dojo/_base/lang",
	"dijit/registry",
	"dijit/Dialog",
	"dijit/form/Button",
...
        return declare(Dialog, {
			...
			title:'Configure Supervisor Training',
...
            //templateString: template, // Our template - important!
			...
			startup:function(){
				...
				this.submitSAPButton = this.getWidget('submitSAPButton');
			...
			onShow:function(){
				...
				this.eventHandlers.push( on(this.submitSAPButton, 'click', lang.hitch(this, "onSubmitClicked")) );
			},
