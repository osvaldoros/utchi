define([
	...
	function(declare, on, WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, StatefulModule, template, lang, Button, Manager, DCFormManager,
		...
		return declare("app.modules.companies.companySetup.configServices.configAlcohol.Results", [WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, StatefulModule, DCFormManager], {
			...
			startup:function(){
				...
				this.labCombo = this.getWidget('default_lab_id');
				this.mroCombo = this.getWidget('default_mro_id');
				...
				this.alcoholResultsForm = this.getWidget('alcoholResultsForm');
				this.alcoholResultsForm.set("storeUrl", emanda2.urls.COMPANY);
				this.configureForm(this.alcoholResultsForm)
			...
			onActivate:function(){
				...
				emanda2.entities.getEntityFromHash(emanda2.urls.COMPANY, function(company){
					...
					owner.viewInForm(company, owner.alcoholResultsForm, arrayPropIndexes)			
				});				
			}
