define([
	"dojo/_base/declare",
	"dojo/on",
	"dojo/text!./templates/ConfigEAPDialog.html", // this is what includes the html template
	"dojo/_base/lang",
	"dijit/registry",
	"dijit/Dialog",
	"dijit/form/Button",
...
            //templateString: template, // Our template - important!
			...
			startup:function(){
				...
				this.submitEAPButton = this.getWidget('submitEAPButton');
			...
			onShow:function(){
				...
				this.eventHandlers.push( on(this.submitEAPButton, 'click', lang.hitch(this, "onSubmitClicked")) );
			},
